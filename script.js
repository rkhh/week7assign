...
document.getElementById('BtnDonate').addEventListener('click', function(){
  ...
  var donationDisplay = document.createElement('h3'), donationText, articleElements;

    donationDisplay.setAttribute('style', 'color: #ff2d45;');
  ...
  if (donatePrompt >= 100){
    donationText = document.createTextNode('Thank you for your generous donation.');
  }else{
